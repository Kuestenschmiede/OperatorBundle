...
$GLOBALS['TL_LANG'][$strName]['gutesIoUrl'] = ['URL für gutes.io', 'Geben Sie hier die URL für die gutes.io Kommunikation an (zwingend erforderlich).'];
$GLOBALS['TL_LANG'][$strName]['gutesIoKey'] = ['API-Schlüssel für gutes.io', 'Geben Sie hier Ihren Betreiberschlüssel an (zwingend erforderlich).'];

...
$GLOBALS['TL_DCA']['tl_module']['palettes']['showcase_list_module'] =
    '{title_legend},name,headline,type;' . '{generic_legend},gutesio_data_render_searchHtml,gutesio_data_layoutType,'.
    'gutesio_data_redirect_page,gutesio_data_show_details,gutesio_data_limit,'.
    'gutesio_data_max_data,gutesio_data_mode,gutesio_data_restrict_postals,gutesio_data_show_image,gutesio_data_show_category,gutesio_data_show_city,gutesio_data_show_selfHelpFocus;' . '{showcase_filter_legend},gutesio_initial_sorting,gutesio_enable_filter,gutesio_enable_ext_filter,gutesio_data_change_layout_filter,gutesio_enable_tag_filter,gutesio_enable_type_filter,gutesio_enable_location_filter,gutesio_disable_sorting_filter;' . '{performance_legend},gutesio_strict_images';
...
$GLOBALS['TL_DCA']['tl_module']['palettes']['showcase_detail_module'] =
    '{title_legend},name,headline,type;' . '{generic_legend},gutesio_data_render_searchHtml,gutesio_showcase_list_page,gutesio_load_klaro_consent,gutesio_data_mode,customTpl;' . '{content_legend},gutesio_without_tiles,gutesio_data_max_data;' . '{cart_legend},cart_page'
;

$GLOBALS['TL_DCA']['tl_module']['palettes']['offer_list_module'] =
    '{title_legend},name,headline,type;' . '{generic_legend},gutesio_data_layoutType,gutesio_child_showcase_link,gutesio_data_render_searchHtml;' . '{load_legend},gutesio_child_data_mode,gutesio_data_elements,gutesio_data_limit,gutesio_data_max_data,gutesio_child_sort_by_date,gutesio_hide_events_without_date, gutesio_data_show_city;' . '{cart_legend},cart_page;' . '{showcase_filter_legend},gutesio_enable_filter,gutesio_enable_location_filter,gutesio_enable_ext_filter,gutesio_child_search_label,gutesio_child_search_placeholder,'.
    'gutesio_child_search_description,gutesio_child_text_search,gutesio_child_text_no_results,'.
    'gutesio_child_filter,gutesio_data_change_layout_filter,gutesio_enable_tag_filter, gutesio_enable_category_filter,gutesio_disable_sorting_filter;' . '{performance_legend},gutesio_strict_images';

$GLOBALS['TL_DCA']['tl_module']['palettes']['offer_detail_module'] =
    '{title_legend},name,headline,type;' . '{generic_legend},gutesio_data_render_searchHtml,gutesio_offer_list_page,gutesio_without_tiles,limit_detail_offers,gutesio_without_contact,gutesio_child_data_mode;{cart_legend},cart_page,customTpl'
;
...
$GLOBALS['TL_DCA']['tl_module']['palettes']['showcase_carousel_module'] = '{title_legend},name,headline,type;' . '{generic_legend},gutesio_data_redirect_page,gutesio_data_max_data,gutesio_data_mode,gutesio_data_restrict_postals,gutesio_carousel_template';
...
$GLOBALS['TL_DCA']['tl_module']['palettes']['banner_module'] = '{title_legend},name,headline,type;' . '{load_legend},gutesio_data_mode,gutesio_child_data_mode,gutesio_max_childs,lazyBanner,reloadBanner,loadMonth,gutesio_banner_folder,gutesio_banner_skip_unlinked,gutesio_banner_play_videos,gutesio_banner_mute_videos,gutesio_kiosk_mode,gutesio_banner_show_sound_button,gutesio_banner_show_event_overlay,gutesio_banner_video_timeout;' . '{appearance_legend},gutesio_banner_fullscreen,gutesio_banner_height_value,gutesio_banner_height_unit,gutesio_banner_width_value,gutesio_banner_width_unit,gutesio_banner_theme_color,gutesio_banner_overlay_opacity,gutesio_banner_hide_poweredby,gutesio_banner_media_bg_portrait,gutesio_banner_media_bg_full,gutesio_banner_hide_event_endtime,gutesio_banner_footer_align_left,gutesio_banner_show_ad_label,gutesio_banner_links_new_tab,gutesio_banner_hide_footer_on_videos;' . '{performance_legend},gutesio_banner_lazy_mode,gutesio_banner_limit_initial,gutesio_banner_defer_assets,gutesio_banner_defer_qr,gutesio_banner_qr_for_images,gutesio_banner_interval,gutesio_banner_strict_images';
$GLOBALS['TL_DCA']['tl_module']['palettes']['banner_module'] .= '{security_legend},gutesio_banner_guard_param,gutesio_banner_guard_value';
$GLOBALS['TL_DCA']['tl_module']['palettes']['nearby_showcase_list_module'] = '{title_legend},name,headline,type;' . '{generic_legend},gutesio_data_mode,gutesio_data_redirect_page,gutesio_data_max_data,gutesio_check_position,gutesio_show_detail_link';

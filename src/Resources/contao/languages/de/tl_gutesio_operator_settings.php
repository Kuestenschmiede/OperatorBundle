...
$GLOBALS['TL_LANG'][$strName]['aiAssistantId'] = ["KI Assistant ID", "Geben Sie eine OpenAI Assistant ID an. Diese müssen Sie im OpenAI Dashboard (https://platform.openai.com/assistants) erstellen. Der Assistant sollte die 'File Search' Funktion aktiviert haben."];
$GLOBALS['TL_LANG'][$strName]['aiVectorStoreId'] = ["KI Vector Store ID", "Dieses Feld wird automatisch befüllt, sobald die ersten Daten an OpenAI übertragen wurden. Sie müssen hier normalerweise nichts manuell eintragen."];
$GLOBALS['TL_LANG'][$strName]['aiApiEndpoint'] = ["KI API Endpunkt", "Geben Sie den API Endpunkt der KI an (z.B. OpenAI Chat Completion)."];
...
$GLOBALS['TL_LANG'][$strName]['ratingPage'] = ['URL für Bewertungen', 'Geben Sie die URL zur Bewertungsseite in der Main-Instance an.'];
